...
Begin VB.Form frmVendaCombo 
   ...
   Begin VSFlex7LCtl.VSFlexGrid vsfBoletim 
      ...
      FormatString    =   $"frmVendaCombo.frx":0000
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "frmVendaCombo"
...
Private Sub cmdOK_Click()
    impriminto = True
    Call ImprimeVendaCombo(dtpDtIni, dtpDtFim)
    impriminto = False
End Sub

Public Sub ImprimeVendaCombo(ByVal dDataIni As Date, ByVal dDataFim As Date)
